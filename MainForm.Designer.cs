namespace FileChecker
{
    partial class FileChecker
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.fileNamesField.Text = "Controller,DatabaseCache,Export,FlexiBR,FlexiEx,InvoiceSettings,MorphoRes,ProtectionRes,Rules,Scan,ScanStation,ScanStationBR,ServerScan,Shell,TechResources,TrainingUI,RS.MailToolsRes,RS.MapiConnector.x64.Res,RS.MapiConnector.x86.Res";
